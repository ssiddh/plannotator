/**
 * Authentication middleware for the @plannotator/github plugin.
 *
 * Extracted from apps/paste-service/auth/middleware.ts.
 *
 * Validates GitHub tokens and enforces ACL rules on paste access.
 */

import type { PasteACL, AuthResult, GitHubUser } from "../shared/types.ts";
 ...
 * @param kv - Optional KV namespace for caching (kv?: KVNamespace -- typed as any to avoid Cloudflare dependency)
 */
 ...
 *
 * @param kv - Optional KV namespace for team membership caching (kv?: KVNamespace -- typed as any to avoid Cloudflare dependency)
 */
 ...
 *
 * @param kv - Optional KV namespace (kv?: KVNamespace -- typed as any to avoid Cloudflare dependency)
 */
